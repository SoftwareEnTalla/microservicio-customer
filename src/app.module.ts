...
import { CustomerCommandController } from "./modules/customer/controllers/customercommand.controller";
...
import { LoggingModule } from "./modules/customer/modules/logger.module";
...
@Module({
   ...
   */
  controllers: [
  //No se recomienda habilitar los controladores si ya fueron declarados en el módulo: CustomerModule
  /*
  ...
  */
  ...
  /**
   * Proveedores (Servicios, Repositorios, etc.) de Customer
   *
   ...
   */
  exports: [CustomerCommandService, CustomerQueryService,LoggerService],
})
export class CustomerAppModule implements OnModuleInit {
  /**
