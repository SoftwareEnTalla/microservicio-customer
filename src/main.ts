...
async function bootstrap() {
  ...
  try {
    ...
    logger.info(`ℹCreando instancia del módulo CustomerAppModule...`);
    const app = await NestFactory.create(CustomerAppModule, {
    ...
    const swaggerPath = setupSwagger(
      ...
      "API completa para gestión de Customers con documentación automática",
      "1.0"
    );
