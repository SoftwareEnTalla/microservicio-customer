...
@Module({
  controllers: [CustomerGatewayOnboardingCommandController],
  providers: [
  ...
  exports: [CustomerGatewayOnboardingAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthCustomerGatewayOnboardingModule {}
