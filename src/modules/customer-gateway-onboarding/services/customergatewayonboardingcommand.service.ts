...
export class CustomerGatewayOnboardingCommandService implements OnModuleInit {
  ...
  private async applyDslServiceRules(
    ...
    if (operation === 'update') {
      ...
      if (!(this.dslValue(entityData, currentData, inputData, 'status') === 'APPROVED' && !(this.dslValue(entityData, currentData, inputData, 'completedAt') === undefined || this.dslValue(entityData, currentData, inputData, 'completedAt') === null || (typeof this.dslValue(entityData, currentData, inputData, 'completedAt') === 'string' && String(this.dslValue(entityData, currentData, inputData, 'completedAt')).trim() === '') || (Array.isArray(this.dslValue(entityData, currentData, inputData, 'completedAt')) && this.dslValue(entityData, currentData, inputData, 'completedAt').length === 0) || (typeof this.dslValue(entityData, currentData, inputData, 'completedAt') === 'object' && !Array.isArray(this.dslValue(entityData, currentData, inputData, 'completedAt')) && Object.keys((this.dslValue(entityData, currentData, inputData, 'completedAt') ?? {}) as Record<string, unknown>).length === 0)))) {
