...
import { CustomerOnboardingStatusCreatedEvent } from './customeronboardingstatuscreated.event';
import { CustomerOnboardingStatusUpdatedEvent } from './customeronboardingstatusupdated.event';
import { CustomerOnboardingStatusDeletedEvent } from './customeronboardingstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'customer-onboarding-status-created': createEventDefinition('customer-onboarding-status-created', CustomerOnboardingStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['customer-onboarding-status-created']),
  'customer-onboarding-status-updated': createEventDefinition('customer-onboarding-status-updated', CustomerOnboardingStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['customer-onboarding-status-updated']),
  'customer-onboarding-status-deleted': createEventDefinition('customer-onboarding-status-deleted', CustomerOnboardingStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['customer-onboarding-status-deleted']),
