...
@Module({
  controllers: [CustomerOnboardingStatusCommandController],
  providers: [
  ...
  exports: [CustomerOnboardingStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthCustomerOnboardingStatusModule {}
