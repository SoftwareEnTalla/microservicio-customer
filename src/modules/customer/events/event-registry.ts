...
import { CustomerDeletedEvent } from './customerdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  ...
  'customer-deleted': createEventDefinition('customer-deleted', CustomerDeletedEvent, EVENT_DEFINITION_OVERRIDES['customer-deleted']),
