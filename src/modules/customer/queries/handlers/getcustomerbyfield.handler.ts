...
import { GetCustomerByFieldQuery } from '../getcustomerbyfield.query';
import { CustomerQueryService } from '../../services/customerquery.service';

@QueryHandler(GetCustomerByFieldQuery)
export class GetCustomerByFieldHandler implements IQueryHandler<GetCustomerByFieldQuery> {
  constructor(private readonly queryService: CustomerQueryService) {}

  async execute(query: GetCustomerByFieldQuery) {
